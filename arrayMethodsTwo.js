...
let endsWithI = cities.filter((element)=> element.endsWith('i'))
...
fruits.forEach((element, index)=>{
  if(element.color === 'red'){
    console.log(`The fruit with the index of ${index} is an apple`)
  } else if(element.color === 'orange') {
    console.log(`The fruit with the index of ${index} is an orange.`)
  } else {
    console.log(`The fruit with the index of ${index} is neither an apple or an orange.`)
  }
})
...
// The fruit with the index of 0 is neither an apple or an orange.
// The fruit with the index of 1 is an orange.
// The fruit with the index of 2 is neither an apple or an orange.
...
let totalRice = foods.filter((element)=> element.tags.includes('rice')).reduce((acc,curr)=> acc + curr.price,0)
